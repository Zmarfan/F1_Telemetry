...
namespace F1_Options
{
    ...
    public class DreamCommentator : MonoBehaviour
    {
        ...
        [SerializeField] Options _options;
        ...
        {
            DreamCommentatorInitPackage package = new DreamCommentatorInitPackage()
            {
                participantData = _participantData,
                portraitData = _portraitData,
                optionData = _options.OptionData,
            };

            GameObject obj = Instantiate(_gameManagerPrefab, Vector3.zero, Quaternion.identity);
            obj.GetComponent<GameManager>().Init(package);
            obj.SetActive(true);
        ...
        /// <summary>
        /// Data to send to GameManager to initilize values
        /// </summary>
        public struct DreamCommentatorInitPackage
        {
            public List<ParticipantData> participantData;
            public List<ParticipantManager.NumberSpriteStruct> portraitData;
